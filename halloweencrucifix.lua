...
local CrucifixTool = game:GetObjects("rbxassetid://11803111436")[1]
CrucifixTool.Name = "NewCrucifix"
...
local function func(ins)
	...
	if ins:GetAttribute("IsCustomEntity")==true and ins:GetAttribute("ClonedByCrucifix")~=true then
		local Chains = game:GetObjects("rbxassetid://11803106473")[1]
...
dupeCrucifix.Event:Connect(function(time, entityRoot)
	local Cross = game:GetObjects("rbxassetid://11803111436")[1]
